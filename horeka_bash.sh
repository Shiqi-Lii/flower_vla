#! /bin/bash
#SBATCH -p dev_accelerated # accelerated-h100 # dev_accelerated
#SBATCH -A hk-project-sustainebot
#SBATCH -J flower_vla_policy

# Cluster Settings
#SBATCH -n 1       # Number of tasks
#SBATCH -c 16  # Number of cores per task
#SBATCH -t 30:00 # 30:00 # 2-00:00:00 # 1:00:00 # 2-00:00:00 ## # 06:00:00 # 1-00:30:00 # 2-00:00:00
#SBATCH --gres=gpu:4
#SBATCH --ntasks-per-node=1

# Define the paths for storing output and error files
#SBATCH --output=/hkfs/work/workspace/scratch/lx7270-flower/Codes/flower_vla_policy/logs/slurm_logs/%x_%j.out
#SBATCH --error=/hkfs/work/workspace/scratch/lx7270-flower/Codes/flower_vla_policy/logs/slurm_logs/%x_%j.err


# Activate the virtualenv / conda environment
source /home/hk-project-robolear/lx7270/miniconda3/bin/activate flower_rss
...
accelerate launch --main_process_port 29872 \
    /hkfs/work/workspace/scratch/lx7270-flower/Codes/flower_vla_policy/flower/training.py \
    +HOME=$TMPDIR ++batch_size=128
